...
public class AsteroidFieldTest  {
    ...
    private AsteroidField toTest;

    /**
     * Setting up the AsteroidField class for the test.
     */
    @Before
    public void initialize() {
        toTest = new AsteroidField(1, "TestEvent", "An Event to test the Class.", 42, 42, 99.42);
    }
