 ...
 */
public class HostileShipTest {

    private HostileShip toTest;

    /**
     * Setting up the HostileShip class for the test.
     */
    @Before
    public void initialize() {
        toTest = new HostileShip(1, "TestEvent", "An Event to test the Class.", 42, 42, 99.42);
    }
