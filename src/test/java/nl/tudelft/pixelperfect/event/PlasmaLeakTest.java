 ...
 */
public class PlasmaLeakTest  {

    private PlasmaLeak toTest;

    /**
     * Setting up the PlasmaLeak class for the test.
     */
    @Before
    public void initialize() {
        toTest = new PlasmaLeak(1, "TestEvent", "An Event to test the Class.", 42, 42, 99.42);
    }
