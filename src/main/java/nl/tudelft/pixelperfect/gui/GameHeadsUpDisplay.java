...
/**
 * Class responsible for the display, refreshing, and functionality of the
 * heads-up display (HUD) that is displayed during the active gameplay for the
 * Client. Score and Ship health are displayed constantly, and the current
 * events are shown when they arise.
 * 
...
public class GameHeadsUpDisplay {
	...
	/**
	 * Private class responsible for setting-up the bitmap fonts and attaching
	 * the HUD elements to the guiNodes.
	 */
	...
	/**
	 * Initializer for the health display, including font loading and text
	 * setting.
	 */
	...
	/**
	 * Initializer for the score display, including font loading and text
	 * setting.
	 */
	...
	/**
	 * Method responsible for the updating of the hud text and displaying the
	 * events, along with their remaining time and health, and other HUD
	 * elements.
	 */
	...
	/**
	 * Clears the heads-up display and detaches all the GUI elements. Should
	 * only be called when the game is done and reset.
	 */
