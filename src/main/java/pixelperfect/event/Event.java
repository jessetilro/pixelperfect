...
public class Event {
   ...
   * @param timestamp the tiemstamp of start of the event
   * @param duration the duration of the event
   * @param damage the damage done to the ship on even failure
   */
  public Event(int type, String summary, String description, double timestamp, double duration,
      double damage) {
    this.type = type;
  ...
  /**
   * Updates the duration by subtracting the given double from the current time left.
   * 
